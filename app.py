...
def get_venue_summary(venue):
  return {
    "id": venue.id,
    "name": venue.name,
    "num_upcoming_shows": len(identify_shows(venue)["upcoming_shows"])
  }
...
def delete_venue(venue_id):
  ...
  # ONGOING TODO BONUS CHALLENGE: Implement a button to delete a Venue on a Venue Page, have it so that
